  ...
  return (
    <SidebarProvider>
      <div className="flex h-screen w-full">
        <Sidebar className="w-16 bg-gray-50 border-r border-gray-200">
          <SidebarContent>
            ...
            <div className="mt-auto p-2">
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton onClick={handleLogout} className="flex flex-col items-center justify-center h-12 rounded-lg mx-1 hover:bg-gray-100" tooltip="Đăng xuất">
